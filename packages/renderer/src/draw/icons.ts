...
/**
 * Eingebettete Icon-Pfade aus Google Material Icons (Apache-2.0, © Google).
 * 24x24-viewBox-Pfade. `drawIcon` rendert sie als SVG (Renderer), `iconMarkup` als HTML-String
 * (Palette/ContextPad/Buttons) mit `fill: currentColor` (Farbe via CSS steuerbar).
 * Quelle: https://github.com/google/material-design-icons (Apache License 2.0).
 */
...
/** radio_button_unchecked — Ring (Komponente / Event). */
export const ICON_CIRCLE =
  'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z';
/** arrow_forward — Verbinden. */
...
/** settings — Zahnrad (Element-Einstellungen / Popup). */
...
/** layers — Submap (verschachtelte Karte). */
...
/** autorenew — Beschaffungsmethode durchschalten (build/buy/outsource). */
...
/** Liefert ein Icon als HTML-SVG-String (fuer Palette/ContextPad/Buttons), Farbe = currentColor. */
